// data.go — the GORM layer for tenant-scoped persistence.
//
// This package gives a database-side guarantee: a row-security policy that
// makes a query which forgot its WHERE return nothing. That guarantee only
...
//
// So this file takes over the three places the column could go missing:
//
